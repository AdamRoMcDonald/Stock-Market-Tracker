...
//Singleton pattern. Meaning this frame exists always, and when it's reopened it's just made visible.
...
public class MainMenu extends JFrame {
    ...
    private JButton[] optionButtons(StockHashTable table, BufferedImage icon) {
        ...
        viewSave.addActionListener(e -> {
            try {
                ...
                File file = new File("SMHSave.txt");
    ...
    public static MainMenu getInstance(StockHashTable SHT) throws IOException {
        if (mmInstance == null) {
            mmInstance = new MainMenu(SHT);
        }
        return mmInstance;
    }
